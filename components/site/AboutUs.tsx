...
const AboutUs = () => {
  return (
    <section id="about-us" className="bg-white dark:bg-gray-900 container mx-auto max-w-7xl px-8 md:px-24 py-32 md:mt-20" aria-label="Tentang Kami">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-20 items-center justify-center">
          <div className="text-left">
            <Badge className="text-orange-600 dark:text-orange-400 font-medium bg-orange-100 dark:bg-orange-900/30 mb-4 text-base">Rangkai Web</Badge>
            <h2 className="text-3xl lg:text-4xl text-gray-900 dark:text-white mb-8">Membangun Website, Menguatkan Brand</h2>
